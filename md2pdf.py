...
class ThemeConfig:
    ...
    def __init__(self, theme_name: str = "Standard", config_path: Optional[str] = None):
        ...
        self.email = "<a href='mailto:iee@tugraz.at' target='_blank' style='color: #666;'>iee@tugraz.at</a>"
        self.website = "<a href='https://iee.tugraz.at' target='_blank' style='color: #666;'>iee.tugraz.at</a>"
